...
public class AllCollectionFrame extends javax.swing.JFrame {
    
    private String search;
    private int searchMode = 1;
    List<Conteudo> conteudo;
    
    public AllCollectionFrame() {
        this.searchMode = 1;
        this.search = "";
        initComponents(); 
        updateConteudo();
    ...
    private void updateConteudo(){
         conteudo = FACADE.getOrderedConteudo(searchMode, search, FACADE.getConteudo());
    ...
    private void initComponents() {
        ...
        removeButton.setText("Add To Collection");
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        ...
        FACADE.addToFromCollection(musicTable.getValueAt(musicTable.getSelectedRow(), 0).toString());
    ...
    private void removeButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButton1ActionPerformed
        ...
        new EditConteudoFrame(nome,false).setVisible(true);
        this.dispose();
